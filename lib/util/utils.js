...
exports.createMySQLManagementClient = function (subscription) {
  var factoryMethod = require('azure-arm-mysql');
  return this.createAutoRestClient(factoryMethod, subscription);
};

exports.createPostgreSQLManagementClient = function (subscription) {
  var factoryMethod = require('azure-arm-postgresql');
  return this.createAutoRestClient(factoryMethod, subscription);
};
